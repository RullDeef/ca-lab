...
def composite_integrate(f: func, a1: float, b1: float, a2: float, b2: float, method_1: func, method_2: func, n1: int, n2: int) -> float:
    F = lambda y: method_1(lambda x: f(x, y), a1, b1, n1)
    return method_1(F, a2, b2, n2)
...
eps = [function(t, 5, 5) for t in tao]
